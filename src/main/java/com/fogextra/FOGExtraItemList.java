...
public enum FOGExtraItemList implements IItemContainer {
    ...
    FOGExtraItemList(boolean aDeprecated) {
        if (aDeprecated) {
            mDeprecated = true;
            mHasNotBeenSet = true;
        }
    ...
    public FOGExtraItemList set(Item aItem) {
        if (aItem == null) return this;
        return set(Utils.newItemStack(aItem));
    }

    public FOGExtraItemList set(ItemStack aStack) {
        ...
        if (Utils.isClientSide()) {
            ...
            if (Block.getBlockFromItem(item) == GregTechAPI.sBlockMachines) {
                FOGExtra.addToMachineList(mStack.copy());
            }
        }
        return this;
    }

    public FOGExtraItemList set(IMetaTileEntity metaTileEntity) {
